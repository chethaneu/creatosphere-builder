  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{
    ...
    backgroundAttachment: "fixed"
      ...
      <div className="container mx-auto px-4 py-20 text-center relative z-10 animate-fade-in">
        ...
        <p className="text-lg md:text-xl mb-10 max-w-3xl mx-auto text-muted-foreground leading-relaxed">We build Final Year &amp; Mini Projects in Full Stack Development, Deep Learning, Machine Learning, and Mobile Apps — all within your budget.</p>
        
        <Button onClick={scrollToForm} size="lg" className="bg-gradient-to-r from-primary to-secondary hover:opacity-90 text-primary-foreground font-bold text-lg px-8 py-6 glow-primary transition-all hover:scale-105">
          Get Your Project
        </Button>
      </div>
